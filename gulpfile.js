...
function watch_theme_templates() {
    return gulp.watch(["./components/**/templates/**/*.liquid", "./layouts/**/templates/**/*.liquid"], gulp.series(["theme_templates"]));
}
...
function deploy() {
    ...
    return gulp.src('./theme_files/+(assets|layout|snippets|templates|locales|sections)/**')
